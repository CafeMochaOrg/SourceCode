<?php
/**
 * Template Name: Publish A Document Page Template
 *
...
//        $error_message = 'ERROR : Please Write A Story ';
    ...
    if ($error_message == '') {
        ...
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        $msg = 'You are successfully publish a document.';
        wp_redirect(get_bloginfo('siteurl'));
        exit();
    }else {
...
<div id="primary" class="site-content">
    <div id="content" role="main">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            <div class="form_wrap">
                <div class="form_wrap_title"><h2>Publish A Document</h2></div>
                <div class="form_cont">
                    <?php
                    if ($m != "") {
                        ?>
                ...
                <div class="form_cont">
                    ...
                    <div class="form_right">
                        <input type="submit" class="form_submit" value="Publish" name="Publish" />
                    </div>
                </div>
                <!---->
            </div><!--End .form_wrap-->
