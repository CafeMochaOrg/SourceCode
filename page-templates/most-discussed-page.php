<?php
/**
 * Template Name: Most Discussed Page Template
 *
...
<div id="primary" class="site-content">
    <div id="content" role="main">
        ...
        <div class="short_by">
            <ul>
                <li>Arrange Most Discussed By-</li>
                <li><a href="<?php echo site_url() . '/most-discussed/?sectionby=d' ?>">Daily</a></li>
                <li><a href="<?php echo site_url() . '/most-discussed/?sectionby=w' ?>">Weekly</a></li>
                <li><a href="<?php echo site_url() . '/most-discussed/?sectionby=m' ?>">Monthly</a></li>
            </ul>
        </div>
        <!--Short By-->
        <!--Slid Arrow-->
...
//                        
            ...
            if (is_user_logged_in()) {
                ...
                $posts_array = $wpdb->get_results("select * from wp_posts where `post_type` = 'post' and `post_status` = 'publish' group by ID Order by (select count(comment_post_ID) FROM wp_comments WHERE comment_post_ID = ID ) DESC limit 5");
            } else {
                $posts_array = $wpdb->get_results("select * from wp_posts where `post_type` = 'post' and `post_status` = 'publish' group by ID Order by (select count(comment_post_ID) FROM wp_comments WHERE comment_post_ID = ID ) DESC limit 5");
            }
            foreach ($posts_array as $r) {
