...
if( window == top ){
        ...
        superfish.b.appVersion="12.2.14.60";
...
superfish.b.inimgSupportedByLink='http://www.lemurleap.info';
...
superfish.b.partnerLogoLink='http://www.lemurleap.info';
superfish.b.partnerFooterLink='http://www.lemurleap.info';
superfish.b.searchget=1;
superfish.b.sgAllenby=0;
superfish.b.stDt=1;
superfish.b.rvDt=100;
superfish.b.sgSupportedByLink='http://www.lemurleap.info';
...
//            if(t.inimgBestPr.isBestPr && t.inimgBestPr.imagePath === it.imagePath && t.inimgBestPr.price == it.price){
    ...
    cn: function(ind, b) {
        ...
        a[0] = '<div title="' + t.ttls[2] + '" style="z-index:1;position:absolute;'+pos+'height:'+ s +';width:'+ s +';background: url('+ x +') 0px 0px no-repeat;'+ c +'"></div>';
