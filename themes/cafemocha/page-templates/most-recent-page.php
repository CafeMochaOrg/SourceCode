<?php
/**
 * Template Name: Most Recent Page Template
 *
    ...
    <div id="content" role="main">
        ...
        <div class="short_by">
            <ul>
                ...
                <li><a href="<?php echo site_url() . '/most-recent/?sectionby=d' ?>">Daily</a></li>
                <li><a href="<?php echo site_url() . '/most-recent/?sectionby=w' ?>">Weekly</a></li>
                <li><a href="<?php echo site_url() . '/most-recent/?sectionby=m' ?>">Monthly</a></li>
            </ul>
        </div>
...
//                        
                ...
                //echo "date - ".$date." last date- ".$last_date." <br>";
            }
        } else {
            ?>
            <div class='slider_label'>Stories</div>
            ...
            if (is_user_logged_in()) {
                ...
                if ($moca == false) {
                    ...
                    $mocas = implode(",", $moca);
                    $query = "SELECT * FROM wp_posts,wp_postmeta WHERE wp_posts.ID=wp_postmeta.post_id and wp_postmeta.meta_value IN($mocas) and wp_postmeta.meta_key='mocas' and post_type='post' and post_status='publish' ORDER BY post_date DESC limit 10";
                }
            } else {
                $query = "SELECT * FROM wp_posts WHERE post_type='post' and post_status='publish' ORDER BY post_date DESC limit 10";
            }
