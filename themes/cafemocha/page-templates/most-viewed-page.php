 ...
 * Template Name: Most Viewed Page Template
...
<div id="primary" class="site-content">
    ...
    <div id="content" role="main">
        ...
        <div class="short_by">
            ...
            <ul>
                ...
                <li>Arrange Most Viewed By-</li>

                <li><a href="<?php echo site_url() . '/most-viewed/?sectionby=d' ?>">Daily</a></li>

                <li><a href="<?php echo site_url() . '/most-viewed/?sectionby=w' ?>">Weekly</a></li>

                <li><a href="<?php echo site_url() . '/most-viewed/?sectionby=m' ?>">Monthly</a></li>
    ...
    jQuery(document).ready(function() {
        ...
        if (isset($_GET['sectionby'])) {
            ...
            <div class='slider_label'>Stories</div><?php
            ...
            while (strtotime($last_date) <= strtotime($end_date)) {
                ...
                //echo "previousdate - ".$previousdate."<br>";
...
//                echo '</pre>';
            ...
            if (is_user_logged_in()) {
                ...
                if ($moca == false) {
                    ...
                    $posts_array = $wpdb->get_results("SELECT * FROM `wp_posts` p LEFT JOIN wp_views v ON p.`ID` = v.post_id WHERE p.post_type='post' and p.post_status='publish' group by v.post_id Order by SUM(v.views) DESC limit 10");
