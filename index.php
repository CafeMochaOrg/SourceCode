		...
		<?php else : ?>
			...
			?>
				<header class="entry-header">
					<h1 class="entry-title"><?php _e( 'No posts to display', 'cafemocha' ); ?></h1>
				</header>
			...
			?>
				...
				<div class="entry-content">
					<p><?php _e( 'Apologies, but no results were found. Perhaps searching will help find a related post.', 'cafemocha' ); ?></p>
					<?php get_search_form(); ?>
				</div><!-- .entry-content -->
